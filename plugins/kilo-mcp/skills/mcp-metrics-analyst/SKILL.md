...
- **Feedback Loop:** If recurring patterns are found (e.g., missed edge cases, styling mismatches, frequent cancellations), propose adding specific guardrails to future task specifications or creating target Kilo skills — see `task-spec-authoring` for how task-spec quality itself is the main lever on defect rate.
